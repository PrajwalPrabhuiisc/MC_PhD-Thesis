...
<div class="container">
  <form action="action_page.php"  method="POST" onsubmit="return confirm('Are you sure you want to submit this form?');">
	...
	<div class = "row">
		...
		<div class="row">
		<label>
     	  <input type="checkbox" checked = "checked" name="person1" value="Vishal Singh"> Vishal Singh
	...
	<div class = "row">
		...
		<label>
		  ...
		  <input type="checkbox" checked = "checked" name="S3" value = "Microsoft teams"> Microsoft teams
		  <input type="checkbox" checked = "checked"name="S4" value = "Outlook"> Outlook
